...
import dk.mrspring.wasteland.utils.Message.HandlerClient;
import dk.mrspring.wasteland.utils.Message.HandlerServer;
...
public class Wasteland
{
    ...
    public static void preInit(FMLPreInitializationEvent event)
    {
        ...
        NETWORK.registerMessage(HandlerClient.class, Message.class, 0, Side.CLIENT);
        NETWORK.registerMessage(HandlerServer.class, Message.class, 0, Side.SERVER);
