...
import dk.mrspring.wasteland.world.biome.BiomeGenCity;
import dk.mrspring.wasteland.world.biome.BiomeGenForest;
import dk.mrspring.wasteland.world.biome.BiomeGenMountains;
import dk.mrspring.wasteland.world.biome.BiomeGenRadioactive;
...
public class BiomeGenWastelandBase extends BiomeGenBase {
   ...
   public void setCreatureSpawns(List entries, List biomeEntities, boolean spawn) {
      biomeEntities.clear();
      if(spawn) {
