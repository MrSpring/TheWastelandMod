...
public class RenderDayZombie extends RenderBiped<EntityDayZombie>
{
    ...
    private final List<LayerRenderer<EntityDayZombie>> field_177121_n;
    private final List<LayerRenderer<EntityDayZombie>> field_177122_o;
     ...
     */
    public void doRender(EntityDayZombie entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    private void func_82427_a(EntityDayZombie zombie)
    {
    ...
    protected void rotateCorpse(EntityDayZombie bat, float p_77043_2_, float p_77043_3_, float partialTicks)
    {
        if (bat.isConverting())
        {
    ...
    public static class RenderFactory implements IRenderFactory<EntityDayZombie>
    {
        @Override
        public Render<? super EntityDayZombie> createRenderFor(RenderManager manager)
        {
            return new RenderDayZombie(manager);
        }
    }
}
