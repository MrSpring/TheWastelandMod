...
public class CityBuilding
{
    ...
    public static final int cobbleID;
    public static final int mossyCobbleID;
    public static final int stoneID;
    public static final int sandStoneID;
    public static final int stoneBrickID;
    public static final int woolID;
    public static final int glassID;
    public static final int glassPaneID;
    public static final int stainedGlassID;
    public static final int woodPlankID;
    public static final int chestID;
    public static final int spawnerID;
    public static final int airID;
    public static final int bedrockID;
                    ...
                    if (doGen)
                    {
                        ...
                        } else if (this.blocks[count] == chestID)
                        {
                            if (random.nextInt(10) != 0)
                            {
                                ...
                                TileEntityChest var17 = (TileEntityChest) RuinGenHelper.getTileEntity(pos.X + p.X, pos.Y + p.Y, pos.Z + p.Z);
                        ...
                        } else if (this.blocks[count] == spawnerID)
                        {
                            if (random.nextInt(12) != 0)
                            {
                                ...
                                TileEntityMobSpawner mobSpawner = (TileEntityMobSpawner) RuinGenHelper.getTileEntity(pos.X + p.X, pos.Y + p.Y, pos.Z + p.Z);
                                mobSpawner.getSpawnerBaseLogic().setEntityName(var16);
                            }
                        } else
                        {
                            int randomNumber;
    ...
    static
    {
        cobbleID = Block.getIdFromBlock(Blocks.cobblestone);
        mossyCobbleID = Block.getIdFromBlock(Blocks.mossy_cobblestone);
        stoneID = Block.getIdFromBlock(Blocks.stone);
        sandStoneID = Block.getIdFromBlock(Blocks.sandstone);
        stoneBrickID = Block.getIdFromBlock(Blocks.stonebrick);
        woolID = Block.getIdFromBlock(Blocks.wool);
        glassID = Block.getIdFromBlock(Blocks.glass);
        glassPaneID = Block.getIdFromBlock(Blocks.glass_pane);
        stainedGlassID = Block.getIdFromBlock(Blocks.stained_glass);
        woodPlankID = Block.getIdFromBlock(Blocks.planks);
        chestID = Block.getIdFromBlock(Blocks.chest);
        spawnerID = Block.getIdFromBlock(Blocks.mob_spawner);
        airID = Block.getIdFromBlock(Blocks.air);
        bedrockID = Block.getIdFromBlock(Blocks.bedrock);
    }
}
