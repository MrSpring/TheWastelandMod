...
{
    public String name;
    public Schematic[] top;
    public Schematic[] middle;
    public Schematic[] bottom;
    public int width;
    public int length;
    boolean initialized;
    ...
    public SchematicBuilding addSchematic(Schematic s, int layer)
    {
        if (layer == 0)
        {
            this.bottom = this.addSchematic(this.bottom, s);
            this.initialized = true;
        } else if (layer == 1)
        {
            this.middle = this.addSchematic(this.middle, s);
        } else if (layer == 2)
        {
            this.top = this.addSchematic(this.top, s);
        }
