...
public class CityBlockLayout {
   ...
   public CityBlockLayout(List chunkLocation, MultiVector center, Random random, World world) {
   ...
   private List reduceHeightVariation(List chunkLocationIn, MultiVector center) {
   ...
   private List orderChunks(List chunkLocation, MultiVector center) {
   ...
   private void createLayout(List chunkLocation, Random random, World world) {
   ...
   private int[] getAdjChunksInd(MultiVector p, List c) {
   ...
   private int[] getAdjBlocksInd(Vector block, List cityBlocks) {
      int[] ind = new int[]{-1, -1, -1, -1};
