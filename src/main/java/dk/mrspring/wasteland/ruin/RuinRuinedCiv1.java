    ...
    public boolean generate(World world, Random random, int x, int y, int z)
    {
        ...
        if (Layout.checkLevel(lay, 0))
        {
            ...
            if (k4 == 0)
            {
                ...
                TileEntityChest i9 = (TileEntityChest) RuinGenHelper.getTileEntity(x + j7, y - 3, z + j8);
            ...
            TileEntityChest chest1 = (TileEntityChest) RuinGenHelper.getTileEntity(var44, y + 1, l9);
            ...
            if (i10 == 0)
            {
                ...
                if (k11 == 0)
                {
                    ...
                    TileEntityChest var45 = (TileEntityChest) RuinGenHelper.getTileEntity(x + 3, y + 1, z - 3);
