...
public class RuinRuinedCiv1 extends Ruin implements IWorldGenerator
{
   ...
   public boolean generate(World world, Random random, int x, int y, int z) {
      ...
      int j1 = 0;
      int k1 = 0;
      Rectangle pos = new Rectangle(new BlockPos(x, y, z), 6, 6);
         ...
         if(flag1) {
            ...
            if(!flag2) {
               ...
               if(k4 == 0) {
                  ...
                  TileEntityChest i9 = (TileEntityChest)world.getTileEntity(new BlockPos(x + j7, y - 3, z + j8));
               ...
               for(k5 = 0; k5 < 3; ++k5) {
                  ...
                  for(j8 = 0; j8 < 28; ++j8) {
                     ...
                     Material var43;
                     if(k6 == 0) {
                        var43 = RuinGenHelper.getBlock(x, y + k5, z + j7).getMaterial();
                     ...
                     if(k6 == 1) {
                        var43 = RuinGenHelper.getBlock(x + 6, y + k5, z + j7).getMaterial();
                        if(var43.isSolid() && var42 == 0) {
                           if(k5 == 1) {
                              if(random.nextInt(2) == 0) {
                     ...
                     if(k6 == 2) {
                        var43 = RuinGenHelper.getBlock(x + j7, y + k5, z).getMaterial();
                        if(var43.isSolid() && var42 == 0) {
                           if(k5 == 1) {
                              if(random.nextInt(2) == 0) {
                     ...
                     if(k6 == 3) {
                        var43 = RuinGenHelper.getBlock(x + j7, y + k5, z + 6).getMaterial();
                        if(var43.isSolid() && var42 == 0) {
                           if(k5 == 1) {
                              if(random.nextInt(2) == 0) {
               ...
               TileEntityChest chest1 = (TileEntityChest)world.getTileEntity(new BlockPos(var44, y + 1, l9));
               ...
               if(i10 == 0) {
                  ...
                  for(k11 = 0; k11 < 12; ++k11) {
                     if(k10 == 0) {
                        RuinGenHelper.setBlock(x + 2, y + 1, z - 1 - j10, Blocks.oak_fence);
                     }

                     if(k10 == 1) {
                        RuinGenHelper.setBlock(x + 3 + j10, y + 1, z - 4, Blocks.oak_fence);
                     }

                     if(k10 == 2) {
                        RuinGenHelper.setBlock(x + 6, y + 1, z - 1 - j10, Blocks.oak_fence);
                     }
                  ...
                  if(k11 == 0) {
                     ...
                     TileEntityChest var45 = (TileEntityChest)world.getTileEntity(new BlockPos(x + 3, y + 1, z - 3));
