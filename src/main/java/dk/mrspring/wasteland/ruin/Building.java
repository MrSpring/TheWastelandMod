...
public class Building
{
    ...
    public static Building create(int building)
    {
        ...
        {
            case 0:
                return new Building("cTower", 13, 34, 13, ClockTower.BLOCKS, ClockTower.DATA, false);
            case 1:
                return new Building("church", 9, 12, 5, Church.BLOCKS, Church.DATA, false);
            case 2:
                return new Building("diner", 10, 11, 16, Diner.BLOCKS, Diner.DATA, false);
            case 3:
                return new Building("stand", 5, 5, 3, GroceryStand.BLOCKS, GroceryStand.DATA, true);
            case 4:
                return new Building("hospital", 24, 13, 17, Hospital.BLOCKS, Hospital.DATA, false);
            case 5:
                return new Building("largeFarm", 14, 10, 27, LargeFarm.BLOCKS, LargeFarm.DATA, false);
            case 6:
                return new Building("largeHouse1", 11, 9, 9, LargeHouse1.BLOCKS, LargeHouse1.DATA, false);
            case 7:
                return new Building("largeHouse2", 12, 12, 11, LargeHouse2.BLOCKS, LargeHouse2.DATA, false);
            case 8:
                return new Building("library", 14, 10, 14, Library.BLOCKS, Library.DATA, false);
            case 9:
                return new Building("midHouse1", 9, 7, 12, MidHouse1.BLOCKS, MidHouse1.DATA, true);
            case 10:
                return new Building("midHouse2", 9, 9, 8, MidHouse2.BLOCKS, MidHouse2.DATA, true);
            case 11:
                return new Building("smallFarm", 12, 7, 9, SmallFarm.BLOCKS, SmallFarm.DATA, true);
            case 12:
                return new Building("smallHouse1", 5, 5, 4, SmallHouse1.BLOCKS, SmallHouse1.DATA, true);
            case 13:
                return new Building("smallHouse2", 5, 6, 5, SmallHouse2.BLOCKS, SmallHouse2.DATA, true);
            case 14:
                return new Building("well", 4, 5, 4, Well.BLOCKS, Well.DATA, false);
            default:
                return null;
        }
    }
